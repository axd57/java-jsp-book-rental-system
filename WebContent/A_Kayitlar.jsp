        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <a class="btn btn-success btn-sm" href="A_Kayit_Ekle.jsp" role="button">Ekle</a>
                       <form class="form-inline" action="VeriTabaniSorgu.jsp">
							  <input type="hidden" name="islem" value="Ara"> <!-- Hepsinde aynı -->
							  <input type="hidden" name="alan" value="A_Kayitlar.jsp"> <!-- jsp adı -->
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    if(session.getAttribute("ozelsorgu")==null)
                                    	Rs= Db.A_Veri_Getir("Kayitlar", "Hepsi");
                                    else{
                                    	Rs= Db.A_Veri_Getir("Kayitlar", (String.valueOf(session.getAttribute("ozelsorgu"))));
                                    	session.setAttribute("ozelsorgu", null);
                                    }
                                    while(Rs.next()){%>
                                        <tr>
                                            <td><%=Rs.getString("id")%></td>
                                            <td><%=Rs.getString("uyeid")%></td>
                                            <td><%=Rs.getString("kitapid")%></td>
                                            <td><%=Rs.getString("alis_tarihi")%></td>
                                            <td><%=Rs.getString("veris_tarihi")%></td>
                                            <td><%=Rs.getString("ad")%></td>
                                            <td><%=Rs.getString("uyead")%></td>
                                            <td><%=Rs.getString("tel")%></td>
                                            <td>
                                                <a class="btn btn-warning btn-sm" href="a_Kayit_Guncelle.jsp?id=<%=Rs.getString("id")%>" role="button">Güncelle</a>
                                                <a class="btn btn-danger btn-sm" href="a_Veri_Sil.jsp?id=<%=Rs.getString("id")%>&alan=Kayitlar" role="button">Sil</a>
                                            </td>
                                        </tr>
                                    <%} %>
