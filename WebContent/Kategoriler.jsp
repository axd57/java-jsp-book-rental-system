		...
		<div class="row">
            <div class="col-md-2">
                <div class="list-group">
                   <a href="Kategoriler.jsp?alan=hepsi" class="list-group-item list-group-item-action active">
                        Tüm Kitaplar
                    </a>
                    <%ResultSet Rs=Db.A_Veri_Getir("Kategoriler", "Hepsi");
                    while(Rs.next()){
                    %>
                    <a href="Kategoriler.jsp?alan=<%=Rs.getString("id")%>" class="list-group-item list-group-item-action">
                        <%=Rs.getString("ad")%>
                    </a>
                  <%} %>
            ...
            <div class="col-md-10">
					...
					System.out.println("Kategori: "+alan);
					%>
					
					<%Rs=Db.KitapKategoriSec(alan);
                    while(Rs.next()){%>
