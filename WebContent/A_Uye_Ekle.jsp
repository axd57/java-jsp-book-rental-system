                     	...
                     	<form action="VeriTabaniSorgu.jsp">
                           <input type="hidden" name="islem" value="EkleGuncelle"> <!--  Hepsinde aynı -->
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="u_e_ad" required="required">
                            </div>
                            
                            <div class="form-group">
                                <label for="exampleInputEmail1">Şifre</label>
                                <input type="text" class="form-control"  name="u_e_sifre" required="required" minlength="8">
                            </div>
                            
                            <div class="form-group">
                                <label for="exampleInputEmail1">TC</label>
                               	<input type="text" class="form-control"  name="u_e_tc" required="required" minlength="11" maxlength="11">
                            </div>
                            
                           	<div class="form-group">
                                <label for="exampleInputEmail1">E mail</label>
                               	<input type="email" class="form-control"  name="u_e_email" required="required">
                          	</div>

                             <div class="form-group">
                                <label for="exampleInputEmail1">Tel</label>
                               	<input type="number" class="form-control"  name="u_e_tel" required="required">
                            </div>
