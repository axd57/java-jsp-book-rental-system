        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <a class="btn btn-success btn-sm" href="A_Kitap_Ekle.jsp" role="button">Ekle</a>
                       <form class="form-inline" action="VeriTabaniSorgu.jsp">
							  <input type="hidden" name="islem" value="Ara"> <!-- Hepsinde aynı -->
							  <input type="hidden" name="alan" value="A_Kitaplar.jsp"> <!-- jsp adı -->
							  
							  
							  <div class="form-group mx-sm-3 mb-2">
							    <input type="text" class="form-control" name="kelime" placeholder="Kitap adına göre ara"> <!-- Hepsinde aynı -->
							  </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    if(session.getAttribute("ozelsorgu")==null)
                                    	...
                                    	Rs= Db.A_Veri_Getir("Kitaplar", (String.valueOf(session.getAttribute("ozelsorgu"))));
                                    ...
                                    while(Rs.next()){%>
                                        <tr>
                                            ...
                                            <td><%=Rs.getString("adet")%></td>
                                            <td><img src="pictures/<%=Rs.getString("resim")%>" alt="Resim" width="60"></td>
                                            <td><%=Rs.getString("sayfa_sayisi")%></td>
                                            <td>
                                                <a class="btn btn-warning btn-sm" href="a_Kitap_Guncelle.jsp?id=<%=Rs.getString("id")%>" role="button">Güncelle</a>
                                                <a class="btn btn-danger btn-sm" href="a_Veri_Sil.jsp?id=<%=Rs.getString("id")%>&alan=Kitaplar" role="button">Sil</a>
                                            </td>
                                        </tr>
                                    <%} %>
