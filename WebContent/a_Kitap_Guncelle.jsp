                    		...
                    		ResultSet Rs; 
                     		String id=request.getParameter("id"); 
                  			System.out.println("ıd:"+ id); 
                   			...
                   			Rs=Db.A_Veri_Guncelle("Kitaplar", id); 
						
							while(Rs.next()){
								session.setAttribute("secili_kkategori", Rs.getString("kad"));
								session.setAttribute("resim_tut", Rs.getString("resim"));
							}
							
							session.setAttribute("resim_guncelle", id);
						%> 
                            	...
                            	while(Rs.next()){%>
									...
									<%if(session.getAttribute("resim_adi")!=null){ %>
								 	...
								 	<%}	
								 		...
								 		<img src="pictures/<%=Rs.getString("resim")%>" alt="Resim" width="80">
							 		<%}
								}%>
						</form>
                     	...
                     	<form action="VeriTabaniSorgu.jsp">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="k_e_ad" value=<%=Rs.getString("ad")%> required="required">
                            </div>
                              <%}%>
                             ...
                             <div class="form-group">
                                ...
                                <select name="k_e_kategori" class="form-control custom-select my-1 mr-sm-2">
                            		...
                            		while(Rs.next()){%>
	 									<%if(Rs.getString("ad").equals(session.getAttribute("secili_kkategori"))){%>
                            ...
                            <div class="form-group">
                                <label for="exampleInputEmail1">Yazarı</label>
                               	<input type="text" class="form-control"  name="k_e_yazar" value=<%=Rs.getString("yazar")%> required="required">
                            </div>
                            
                           	<div class="form-group">
                                <label for="exampleInputEmail1">Adeti</label>
                               	<input type="number" class="form-control"  name="k_e_adet" value=<%=Rs.getString("adet")%> required="required">
                          	</div>

                             <div class="form-group">
                                <label for="exampleInputEmail1">Sayfa sayısı</label>
                               	<input type="number" class="form-control"  name="k_e_sayfa_sayisi" value=<%=Rs.getString("sayfa_sayisi")%> required="required">
                            </div>
                            <%} %>
