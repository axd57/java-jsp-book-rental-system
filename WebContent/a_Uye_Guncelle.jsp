            ...
            <div class="col-md-12">
                ...
                <div class="card">
                   <div class="card-content">
                     ...
                     Rs=Db.A_Veri_Guncelle("Uyeler", id); 
                   	
                   	 while(Rs.next()){%> 
                     	<form action="VeriTabaniSorgu.jsp">
                           <input type="hidden" name="islem" value="EkleGuncelle"> <!--  Hepsinde aynı -->
							<input type="hidden" name="post" value="A_Uyeler.jsp"> <!--  jsp adı -->
                            <input type="hidden" name="guncelle" value="evet">
                            <input type="hidden" name="gid" value=<%=id%>>
                            
                            <div class="form-group">
                                <label for="exampleInputEmail1">Adı</label>
                                <input type="text" class="form-control"  name="u_e_ad" value=<%=Rs.getString("ad")%> required="required">
                            </div>
                            
                            <div class="form-group">
                                <label for="exampleInputEmail1">Şifre</label>
                                <input type="text" class="form-control"  name="u_e_sifre" value=<%=Rs.getString("sifre")%> required="required">
                            </div>
                            
                            <div class="form-group">
                                <label for="exampleInputEmail1">TC</label>
                               	<input type="text" class="form-control"  name="u_e_tc" value=<%=Rs.getString("tc")%> required="required" minlength="11" maxlength="11">
                            </div>
                            
                           	<div class="form-group">
                                <label for="exampleInputEmail1">E mail</label>
                               	<input type="email" class="form-control"  name="u_e_email" value=<%=Rs.getString("email")%> required="required">
                          	</div>

                             <div class="form-group">
                                <label for="exampleInputEmail1">Tel</label>
                               	<input type="number" class="form-control"  name="u_e_tel" value=<%=Rs.getString("tel")%> required="required">
                            </div>
                            <%} %>
