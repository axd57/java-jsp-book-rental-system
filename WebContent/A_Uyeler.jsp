            ...
            <div class="col-md-12">
                ...
                <div class="card">
                	<div class="card-action">
                		<a class="btn btn-success btn-sm" href="A_Uye_Ekle.jsp" role="button">Ekle</a>
                       	<form class="form-inline" action="VeriTabaniSorgu.jsp">
							  <input type="hidden" name="islem" value="Ara"> <!-- Hepsinde aynı -->
							  <input type="hidden" name="alan" value="A_Uyeler.jsp"> <!-- jsp adı -->
							  
							  
							  <div class="form-group mx-sm-3 mb-2">
							    <input type="text" class="form-control" name="kelime" placeholder="Üye adına göre ara"> <!-- Hepsinde aynı -->
							  </div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    if(session.getAttribute("ozelsorgu")==null)
                                    	...
                                    	Rs= Db.A_Veri_Getir("Uyeler", (String.valueOf(session.getAttribute("ozelsorgu"))));
                                    ...
                                    while(Rs.next()){%>
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning btn-sm" href="a_Uye_Guncelle.jsp?id=<%=Rs.getString("id")%>" role="button">Güncelle</a>
                                                <a class="btn btn-danger btn-sm" href="a_Veri_Sil.jsp?id=<%=Rs.getString("id")%>&alan=Uyeler" role="button">Sil</a>
                                            </td>
                                        </tr>
                                    <%} %>
