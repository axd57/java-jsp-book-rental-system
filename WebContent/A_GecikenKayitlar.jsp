                ...
                <div class="card">
                    <div class="card-action">
                       <form class="form-inline" action="VeriTabaniSorgu.jsp">
							  ...
							  <input type="hidden" name="alan" value="A_GecikenKayitlar.jsp"> <!-- jsp adı -->
                            ...
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    if(session.getAttribute("ozelsorgu")==null)
                                    	Rs= Db.A_Veri_Getir("GecikmisKayitlar", "Hepsi");
                                    else{
                                    	Rs= Db.A_Veri_Getir("GecikmisKayitlar", (String.valueOf(session.getAttribute("ozelsorgu"))));
                                    ...
                                    while(Rs.next()){%>
                                        <tr>
                                            ...
                                            <td><%=Rs.getString("kadi")%></td>
                                            <td><%=Rs.getString("uadi")%></td>
